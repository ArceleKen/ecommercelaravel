...
<div class="col-md-6">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6 col-sm-6 col-lg-6">
            <div class="row">
                <div class=" col-md-6 col-sm-6 col-lg-6">
                    <input type="number" min="0" max="23" name="hrd" required="required" class="form-control col-md-6 col-sm-6 col-lg-6" value="{!! $hd  !!}"/>h
                </div>
                <div class=" col-md-6 col-sm-6 col-lg-6">
                    <input type="number" min="0" max="59" name="mnd" required="required" class="form-control col-md-6 col-sm-6 col-lg-6" value="{!! $md  !!}"/>min
               </div>
            </div>
...
<div class="col-md-6">
    <div class="form-group row">
        ...
        <div class="col-md-6 col-sm-6 col-lg-6">
            <div class="row">
                <div class=" col-md-6 col-sm-6 col-lg-6">
                    <input type="number" min="0" max="23" name="hrf" required="required" class="form-control col-md-6 col-sm-6 col-lg-6" value="{!! $hf  !!}" />h
                </div>
                <div class=" col-md-6 col-sm-6 col-lg-6">
                    <input type="number" min="0" max="59" name="mnf" required="required" class="form-control col-md-6 col-sm-6 col-lg-6" value="{!! $mf  !!}" />min
                </div>
            </div>
        </div>
    </div>
...
<div class="form-group col-lg-12">
    <div class="col-md-3 col-lg-offset-3 ">
        <a href="{!! route('users.index') !!}" class="btn btn-danger "> Retour</a></div>
    <div class="col-md-3">
